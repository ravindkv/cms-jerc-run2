...
auto RunZmmJet::Run(std::shared_ptr<SkimTree>& skimT, EventPick *eventP, ObjectPick *objP, ScaleObject *scaleObject, TFile *fout) -> int{
    ...
    for (Long64_t jentry = 0; jentry < nentries; ++jentry) {
        ...
        histScale.FillMuon(*scaleMuon, weight);
