...
GlobalFlag::GlobalFlag(const string& outName) : isDebug(false), is2016Pre(false), is2016Post(false), is2017(false), is2018(false), isData(false), isMC(false), isZeeJet(false), isZmmJet(false), isGamJet(false), isMultiJet(false), isWqq(false), isQCD(false), isMG(false){
