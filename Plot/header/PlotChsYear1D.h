...
#ifndef PLOT_CHSYEAR1D_H
#define PLOT_CHSYEAR1D_H
...
public:
     ...
     *
     * @param params A FigConfigChsYear1D struct holding directory names, histogram names, style configs, etc.
     */
    void setFigConfigChsYear1D(const FigConfigChsYear1D& params);
...
#include "../tpp/PlotChsYear1D.tpp"

#endif // PLOT_CHSYEAR1D_H
